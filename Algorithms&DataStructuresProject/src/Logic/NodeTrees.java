 ...
 * @author David Robles
 */
class NodoBinario extends Roles {

    String grasa, peso, musculo, hidratacion;

    public NodoBinario(String cedula, String nombre, String apellido, String nombreUsuario, String contraseña, int edad, int telefono, String correo, int rol, String grasa, String peso, String musculo, String hidratacion) {
        super(cedula, nombre, apellido, nombreUsuario, contraseña, edad, telefono, correo, rol);
        this.grasa = grasa;
        this.peso = peso;
