 ...
 * @author Rachel
 */
public class FrmGraficasCliente extends javax.swing.JFrame {

    /**
     * Creates new form FrmGraficas
     */
    public FrmGraficasCliente() {
        initComponents();
    }
    ...
    private void btnGraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraficarActionPerformed
        ...
        public String obtenerCliente(){
            ...
            Persona tempCountries[] = lC.readRegistersFilesIndividual();
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        VerNotasCliente v = new VerNotasCliente();
        v.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGraficasCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGraficasCliente().setVisible(true);
